...
<div class="wrapper">
 ...
 <h3 align="center"> Ajouter un fournisseur</h3>
        <div class="modal-body">
            <form action="ajoutfournisseur.php" method="GET" role="form">
            

                     <div class="form-group">
                      <label for="">CIN</label>
                      <input type="text" name="cin_four" class="form-control" id="cin_four">
                    </div>
                     <div class="form-group">
                      <label for="">Nom du fournisseur</label>
                      <input type="text" name="nom_four" class="form-control" id="nom_four">
                    </div>
                    <div class="form-group">
                      <label for="">Prénom du fournisseur</label>
                      <input type="text" name="prenom_four" class="form-control" id="prenom_four">
                    </div>
                    <div class="form-group">
                      <label for="">Tél</label>
                      <input type="text" name="tel_four" class="form-control" id="tel_four">
                    </div>
                    <div class="form-group">
                      <label for="">date d'ajout</label>
                      <input type="text" name="datee" class="form-control" id="datee">
                    </div>
                    <div class="form-group">
                      <label for="">Adresse</label>
                      <input type="text" name="adr_four" class="form-control" id="adr_four">
                    </div>
