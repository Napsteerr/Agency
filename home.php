...
<div class="wrapper">
    ...
    <div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category"> qui on dépassé le seuil max </p>
                            </div>
            ...
            if(($donnees['quantite']) > 100)
                echo '<tr><td>'.$donnees['id'].'</td><td>'.$donnees['nom_article'].'</td><td>'.$donnees['quantite'].'</td><td>'.$donnees['prix'].'<td></tr>';
            ...
            ?>       
                ...
                <br><br></br><p>Seuil Minimal</p><br><br>
            <table class="table table-hover table-striped">
                                    <thead>
                                       <th>ID d'article</th>
                                       <th>Nom d'article</th>
