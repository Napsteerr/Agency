...
<div class="wrapper">
 ...
 <h3 align="center"> Ajouter un agent</h3>
        <div class="modal-body">
            <form action="ajoutagent.php" method="GET" role="form">
            

                     <div class="form-group">
                      <label for="">ID d'agent</label>
                      <input type="text" name="id_agent" class="form-control" id="id_agent">
                    </div>
                     <div class="form-group">
                      <label for="">Nom d'agent</label>
                      <input type="text" name="nom_agent" class="form-control" id="nom_agent">
                    </div>
                    <div class="form-group">
                      <label for="">Prenom d'agent</label>
                      <input type="text" name="prenom_agent" class="form-control" id="prenom_agent">
                    </div>
                    <div class="form-group">
                      <label for="">Telephone</label>
                      <input type="text" name="tel_agent" class="form-control" id="tel_agent">
                    </div>
                    <div class="form-group">
                      <label for="">Adresse</label>
                      <input type="text" name="adr_agent" class="form-control" id="adr_agent">
                    </div>
