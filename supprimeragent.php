...
include "crudagent.php";
$crud = new crudagent();
$conn=$crud->cnx;//public

$reponse=$crud->afficheagent($conn);
?>
<!doctype html>
<html lang="en">
<head>
...
<div class="wrapper">
    ...
    <div class="main-panel">
     ...
     <div class="content">
            ...
            ?>
                <tr>
                    <th><?php echo $donnees['id_agent'];?></th>
                    <th><?php echo $donnees['nom_agent'];?></th>
                    <th><?php echo $donnees['prenom_agent'];?></th>
                    <th><?php echo $donnees['tel_agent'];?></th>
                    <th><?php echo $donnees['adr_agent'];?></th>

                    <th> <?php echo"<a href='crudDocument.php?supprimer_agent=".$donnees['id_agent']."' >Delete</a>"; ?></th>
